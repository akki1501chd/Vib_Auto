...
describe('TestSuites ', function () {
  ...
  //it(`Run ${i}: visit URL`, function () {
    ...
    it('Edit Proposals Terms and Conditions Form page', function () {
      ...
      // // cy.wait(10000);
      cy.get(':nth-child(1) > .proposal-card > .css-k008qs > .pro_right_cont_cls_des').click();
      cy.get('[data-rbd-draggable-id="a92b320d-085b-4cba-aee4-04f4330bac1b"] > .css-35o7ay').click() //Terms and Conditions
      cy.wait(10000);
    ...
    it('Edit Proposals Warranty Form page', function () {
      ...
      cy.get('[data-rbd-draggable-id="4a0a0b6d-5231-474d-b57f-9a8f89ddc955"] > .css-35o7ay').click();
    ...
    it('Edit Proposals Add_page Form', function () {
      ...
      cy.wait(10000);
      cy.get(':nth-child(1) > .proposal-card > .css-k008qs > .pro_right_cont_cls_des').click()
      cy.get('.css-12rhcm').click() // Add page
      cy.get('[data-rbd-draggable-id="4503dc32-65b0-42a6-841d-982c6fe855eb"] > .css-35o7ay').click( )
